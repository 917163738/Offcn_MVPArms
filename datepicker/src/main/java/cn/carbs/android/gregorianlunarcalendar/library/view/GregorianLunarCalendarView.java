...
public class GregorianLunarCalendarView extends LinearLayout implements NumberPickerView.OnValueChangeListener {
    ...
    private static final int YEAR_STOP = 2030;
    ...
    private int mDividerColor = DEFAULT_GREGORIAN_COLOR;
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (attr == R.styleable.GregorianLunarCalendarView_glcv_DividerColor) {
                mDividerColor = a.getColor(attr, DEFAULT_GREGORIAN_COLOR);
            }
        }
        a.recycle();
    }
...
//    @Override
//    public void onValueChange(cn.carbswang.android.numberpickerview.library.NumberPickerView picker, int oldVal, int newVal) {
//
//    }
